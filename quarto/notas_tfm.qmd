...
# ggsave("C:/PythonCode/TFM_GLS/py/fig-clean-plot.pdf", plot = plot1, width = 22, height = 14, units = "in")
```
...
# ggsave("C:/PythonCode/TFM_GLS/py/fig-subset-plot.pdf", plot = plot1, width = 22, height = 14, units = "in")
```
...
#| fig-width: 22
#| fig-height: 14
#| label: fig-buenos-shuffled
#| fig-cap: "Shuffled pero con RoBERTa y PolBERT"
plot4 <- ggplot(all_df_plot, aes(x = type, y = mean_similarity, fill = type)) +
  geom_dotplot(
    binaxis = "y", stackdir = "center", 
    dotsize = 3, binwidth = 0.01, 
    na.rm = TRUE, alpha = 0.8
...
#| fig-width: 22
#| fig-height: 14
#| label: fig-buenos-clean
#| fig-cap: "Buenos pero con RoBERTa y PolBERT"
plot5 <- ggplot(all_df_plot, aes(x = type, y = mean_similarity, fill = type)) +
  geom_dotplot(
    binaxis = "y", stackdir = "center", 
    dotsize = 3, binwidth = 0.01, 
    na.rm = TRUE, alpha = 0.8
