...
: Mean similarity between pivot and inflection {#tbl-initial-inflection} {.sm}
...
: Mean similarity between pivot and derivation. {#tbl-initial-derivation} {.sm}
...
To create the subset of affixes, we took the most common affixes in the UniMorph data itself. In Spanish the top 15 affixes are: 
...
: Top affixes in Spanish {#tbl-spa-affixes} {.sm}


In Polish, the top 15 affixes are:
...
: Top affixes in Polish {#tbl-pol-affixes} {.sm}