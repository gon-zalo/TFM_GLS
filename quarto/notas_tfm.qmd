...
# ggsave("plots/fig-subset.pdf", plot = plot6, width = 22, height = 14, units = "in")
```
...
# ggsave("plots/fig-baseline.pdf", plot = plot7, width = 12, height = 12, units = "in")
```
...
plot8 <- ggplot(baseline_data, aes(x = mean_similarity, fill = type)) +
  ...
  # geom_vline(xintercept = 0.5, color = "grey", linetype = "solid", size = 0.5) +
  theme_minimal() +
  theme(
    # axis.title.y = element_text(size = 30),
...
# ggsave("plots/fig-baseline-faceted.pdf", plot = plot8, width = 8, height = 14, units = "in")
```