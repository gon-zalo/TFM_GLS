...
: Mean similarity between pivot and inflection {#tbl-initial-inflection}
...
: Mean similarity between pivot and derivation. {#tbl-initial-derivation}
...
: Mean similarity between pivot and inflection on the **clean data** {#tbl-clean-inflection}
...
: Mean similarity between pivot and derivation on the **clean data** {#tbl-clean-derivation}
