...
prf_ft <- read.csv("results/pol/pol_fasttext_perfectives_results.csv")
prf_w2v <- read.csv("results/pol/pol_word2vec_perfectives_results.csv")
...
perfectives <- bind_rows(prf_ft, prf_w2v)

perfectives <- perfectives %>%  
  mutate(model = as.factor(model))

perfectives_plot <- ggplot(perfectives, aes(y = similarity, fill = model, x = model)) +
  geom_dotplot(
      binaxis = "y", stackdir = "center", 
      dotsize = 2, binwidth = 0.005, 
...
# ggsave("plots/perfectives_dotplot.pdf", plot = perfectives_plot, width = 15, height = 7, units = "in")
