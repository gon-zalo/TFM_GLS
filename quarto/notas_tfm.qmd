...
# ggsave("plots/fig-subset-plot.pdf", plot = plot2, width = 22, height = 14, units = "in")
```
...
# ggsave("plots/fig-random-baseline.pdf", plot = plot3, width = 22, height = 14, units = "in")
```
...
# ggsave("plots/fig-clean-bert2.pdf", plot = plot4, width = 22, height = 14, units = "in")
```
...
# ggsave("plots/fig-shuffled-bert2.pdf", plot = plot5, width = 22, height = 14, units = "in")
```
...
# ggsave("plots/fig-subset-v2.pdf", plot = plot6, width = 22, height = 14, units = "in")
```
...
plot7 <- ggplot(baseline_data, aes(x = mean_similarity, fill = type))+
  geom_histogram(binwidth = 0.015, alpha = 0.7, position = "identity", color = 'black') +
...
# ggsave("plots/fig-baseline.pdf", plot = plot7, width = 22, height = 14, units = "in")
```
...
# ggsave("plots/fig-baseline-faceted.pdf", plot = plot8, width = 22, height = 14, units = "in")
